...
export function WishlistScreen() {
  const { products, toggleWishlist, navigateTo, goBack } = useAppStore()
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div>
            ...
            <div style={{ fontSize: 13, color: 'rgba(255,255,255,0.75)', marginTop: 4, fontWeight: 500 }}>
              {wishlistItems.length} {wishlistItems.length === 1 ? 'item' : 'itens'} salvo{wishlistItems.length !== 1 ? 's' : ''}
            </div>
          </div>
          {wishlistItems.length > 0 && (
            <div style={{ background: 'rgba(255,255,255,0.2)', borderRadius: 12, padding: '8px 14px', textAlign: 'center' }}>
              <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.7)', fontWeight: 600 }}>Total</div>
      ...
      {wishlistItems.length === 0 ? (
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: 32, textAlign: 'center' }}>
          ...
          <button
            ...
            style={{
              padding: '13px 28px', background: 'var(--grad-warm)',
              border: 'none', borderRadius: 14, color: '#fff', fontSize: 14, fontWeight: 700, cursor: 'pointer',
            }}
          >
            Explorar loja
          </button>
        ...
        <div className="scroll-area">
          {[
            ...
            { label: '🍔 Alimentação', items: foodItems },
              ...
              {section.items.map(product => (
                ...
                >
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ fontSize: 15, fontWeight: 800, color: 'var(--pink)', marginTop: 4 }}>
                  ...
                  <button
                    ...
                    style={{
                      background: 'rgba(250,20,98,0.08)', border: '1px solid rgba(250,20,98,0.2)',
