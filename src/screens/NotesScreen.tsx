...
export function NotesScreen() {
  ...
  const allSessions = sessions.filter(s => s.type !== 'louvor')
  ...
  return (
    <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', background: 'var(--bg)' }}>
      ...
      <div style={{
        ...
        <div style={{ fontFamily: 'var(--font-display)', fontSize: 26, fontWeight: 700, color: '#fff' }}>Minhas Notas 📝</div>
      ...
      <div className="scroll-area">
        <div style={{ padding: '16px 16px 0' }}>
          ...
          {[1, 2].map(day => {
            ...
            return (
              <div key={day}>
                <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: '1.2px', textTransform: 'uppercase', color: 'var(--text3)', marginBottom: 10, marginTop: day === 2 ? 20 : 0 }}>
                  📅 Dia {day}
                </div>
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        cursor: 'pointer', borderLeft: hasContent ? '3px solid var(--pink)' : '3px solid var(--bg3)',
                    ...
                    >
                      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                        <div>
                          ...
                          {hasContent && (
                            <div style={{ fontSize: 12, color: 'var(--text2)', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', maxWidth: 260 }}>
                              {note!.content}
                            </div>
                          )}
                          {hasContent && note?.updatedAt && (
                            <div style={{ fontSize: 11, color: 'var(--text3)', marginTop: 4 }}>
                              Atualizado às {note.updatedAt}
                            </div>
                          )}
                          {!hasContent && (
